...
#include "../../../build-win10/CUGL/CUBodyNetData.h"
...
#pragma mark Update Methods
            ...
            /*
            * Updates the object's forces. The real parameter is to determine whether we should apply these forces to the realworld or the draw world.
            *
            * This is needed in order to apply forces in an manner that doesn't cause rounding errors.
            *
